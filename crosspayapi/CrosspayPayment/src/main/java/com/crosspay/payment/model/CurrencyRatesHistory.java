...
@Entity
@Table(name = "currencyrateshistory")
public class CurrencyRatesHistory {

	// An autogenerated id (unique for each user in the db)
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int CURRENCYRATEHISTORY_ID;
	...
	public int getCURRENCYRATEHISTORY_ID() {
		return CURRENCYRATEHISTORY_ID;
	}

	public void setCURRENCYRATEHISTORY_ID(int cURRENCYRATEHISTORY_ID) {
		CURRENCYRATEHISTORY_ID = cURRENCYRATEHISTORY_ID;
	}
