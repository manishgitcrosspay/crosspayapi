var app = angular.module('crossPaymodule')
    ...
    app.controller('historyCtrl',['$scope','$http', '$route', '$location', '$localStorage', 'historyFactory', 'showAlert','$rootScope','$filter',
	function ($scope,$http, $route, $location, $localStorage, historyFactory, showAlert,$rootScope,$filter) {
